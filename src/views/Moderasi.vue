  ...
  <div>
      ...
      <v-card>
        ...
        <v-row justify="center" v-if="UnitsDetail !== ''">
          <viewer :images="images">
            <v-col cols="12" sm="12">
              <img :src="$url_img + UnitsDetail.foto_1" width="200px" height="230" />
              <v-list-item-title>Ket: Tampak Depan</v-list-item-title>
            </v-col>
          </viewer>
          <viewer :images="images">
            <v-col cols="12" sm="12">
              <img :src="$url_img + UnitsDetail.foto_2" width="200px" height="230" />
              <v-list-item-title>Ket: Tampak Belakang</v-list-item-title>
            </v-col>
          </viewer>
          <viewer :images="images">
            <v-col cols="12" sm="12">
              <img :src="$url_img + UnitsDetail.foto_3" width="200px" height="230" />
        ...
        <v-row justify="center" v-if="UnitsDetail !== ''">
          <viewer :images="images">
            <v-col cols="12" sm="12">
              <img :src="$url_img + UnitsDetail.foto_4" width="200px" height="230" />
              <v-list-item-title>Ket: Tampak Samping</v-list-item-title>
            </v-col>
          </viewer>
          <viewer :images="images">
            <v-col cols="12" sm="12">
              <img :src="$url_img + UnitsDetail.foto_5" width="200px" height="230" />
              <v-list-item-title>Ket: Detail Foto</v-list-item-title>
            </v-col>
          </viewer>
          <viewer v-if="UnitsDetail.foto_bpkb != null" :images="images">
            <v-col cols="3">
              <img :src="$url_img + UnitsDetail.foto_bpkb" width="170px" height="110" />
            </v-col>
          </viewer>
          <viewer v-if="UnitsDetail.foto_pajak != null" :images="images">
            <v-col cols="3">
              <img :src="$url_img + UnitsDetail.foto_pajak" width="170px" height="110" />
            </v-col>
          </viewer>
        </v-row>
          ...
          <v-col cols="12" sm="4">
            <v-list-item>
              <v-list-item-content>
                ...
                <v-list-item-title class="headline2 mb-1 green--text">{{ UnitsDetail.status }}</v-list-item-title>
              </v-list-item-content>
            </v-list-item>
          </v-col>
          <v-col cols="12" sm="4">
            <v-list-item>
              <v-list-item-content>
                ...
                <v-list-item-title class="headline2 mb-1">{{ UnitsDetail.lokasi }}</v-list-item-title>
              </v-list-item-content>
            </v-list-item>
          </v-col>
        </v-row>
          ...
          <v-col cols="12" sm="4">
            <v-list-item>
              <v-list-item-content>
                ...
                <v-list-item-title class="headline2 mb-1">{{ UnitsDetail.moderasi_deskripsi }}</v-list-item-title>
              </v-list-item-content>
            </v-list-item>
          </v-col>
          <v-col cols="12" sm="4">
            <v-list-item>
              <v-list-item-content>
                ...
                <v-list-item-title class="headline2 mb-1">{{ UnitsDetail.type }}</v-list-item-title>
              </v-list-item-content>
            </v-list-item>
          </v-col>
          <v-divider light></v-divider>
          <v-col cols="12" sm="4">
            <v-list-item>
              <v-list-item-content>
                ...
                <v-list-item-title class="headline2 mb-1">{{ UnitsDetail.tanggal_pajak }}</v-list-item-title>
              </v-list-item-content>
            </v-list-item>
          </v-col>
          ...
          <v-col cols="12" sm="4">
            <v-list-item>
              <v-list-item-content>
                ...
                <v-list-item-title class="headline2 mb-1">{{ UnitsDetail.nomor_polisi }}</v-list-item-title>
              </v-list-item-content>
            </v-list-item>
          </v-col>
          <v-col cols="12" sm="4">
          ...
          <v-col cols="12" sm="4">
            <v-list-item>
              <v-list-item-content>
                ...
                <v-list-item-title class="headline2 mb-1">{{ UnitsDetail.lokasi_samsat }}</v-list-item-title>
              </v-list-item-content>
            </v-list-item>
          </v-col>
          ...
          <v-col cols="12" sm="4">
            <v-list-item>
              <v-list-item-content>
                ...
                <v-list-item-title class="headline2 mb-1">{{ UnitsDetail.merk }}</v-list-item-title>
              </v-list-item-content>
            </v-list-item>
          </v-col>
          <v-col cols="12" sm="4">
          ...
          <v-col cols="12" sm="4">
            <v-list-item>
              <v-list-item-content>
                ...
                <v-list-item-title v-if="UnitsDetail.lembar_stnk == true" class="headline2 mb-1">Ada</v-list-item-title>
              </v-list-item-content>
            </v-list-item>
          </v-col>
          <v-col cols="12" sm="4">
            <v-list-item>
              <v-list-item-content>
                ...
                <v-list-item-title class="headline2 mb-1">{{ UnitsDetail.odometer }}</v-list-item-title>
              </v-list-item-content>
            </v-list-item>
          </v-col>
          ...
          <v-col cols="12" sm="4">
            <v-list-item>
              <v-list-item-content>
                ...
                <v-list-item-title class="headline2 mb-1">{{ UnitsDetail.jenis_motor }}</v-list-item-title>
              </v-list-item-content>
            </v-list-item>
          </v-col>
          <v-divider light></v-divider>
          <v-col cols="12" sm="4">
            <v-list-item>
              <v-list-item-content>
                ...
                <v-list-item-title class="headline2 mb-1">{{ UnitsDetail.transmisi }}</v-list-item-title>
              </v-list-item-content>
            </v-list-item>
          </v-col>
          <v-col cols="12" sm="4">
            <v-list-item>
              <v-list-item-content>
                ...
                <v-list-item-title class="headline2 mb-1">{{ UnitsDetail.cc }}</v-list-item-title>
              </v-list-item-content>
            </v-list-item>
          </v-col>
          <v-col cols="12" sm="4">
    ...
    <v-dialog v-model="dialog.Tolak" persistent max-width="500px">
      <v-card>
        ...
        <v-card-actions>
          <div class="flex-grow-1"></div>
          <v-btn color="red darken-1" dark @click="dialog.Tolak = false">Cancel</v-btn>
          <v-btn color="blue darken-1" dark @click="OnTolak(UnitsDetail.id)">Tolak</v-btn>
        </v-card-actions>
      </v-card>
    </v-dialog>
    ...
    <v-dialog v-model="dialog.Terima" persistent max-width="500px">
      <v-card>
        ...
        <v-card-actions>
          ...
          <v-btn color="blue darken-1" dark @click="OnKonfirmasi(UnitsDetail.id)">Terima</v-btn>
        </v-card-actions>
      </v-card>
    </v-dialog>
