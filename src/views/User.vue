  ...
  <v-card>
    ...
    <v-dialog v-model="dialog.Edit" persistent max-width="600px">
      <v-card>
        ...
        <v-card-actions>
          <v-spacer></v-spacer>
          <v-btn color="red darken-1" dark @click="dialog.Edit = false"
            >Close</v-btn
          >
      ...
      <v-card>
        ...
        <v-card-actions>
          ...
          <v-btn
            ...
            >Hapus HO</v-btn
          >
          <v-btn color="blue darken-1" dark v-else text @click="JoinHO"
            >Tambah HO</v-btn
          >
        </v-card-actions>
      </v-card>
    ...
    <v-dialog v-model="dialog.AddMOU" persistent max-width="600px">
      <v-card>
        ...
        <v-card-actions>
          <v-spacer></v-spacer>
          <v-btn color="red darken-1" dark @click="dialog.AddMOU = false"
            >Close</v-btn
          >
...
export default {
  ...
  methods: {
    ...
    async UpdateMou() {
      ...
      formData2.append('id_mst_user_type', this.ComUserType);
      const resp = await this.$req
